...
public class CraftSnowmanEntity extends CraftSnowman implements BasicNMSEntity {
	
	public CraftSnowmanEntity(SnowmanEntity entity) {
	...
	public void setFrozen(boolean b) {
		((SnowmanEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((SnowmanEntity) entity).isFrozen();
	}
	@Override
	public void setWillSave(boolean b) {
		((SnowmanEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((SnowmanEntity)entity).willSave;
	}
	public static class SnowmanEntity extends EntitySnowman implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftSnowmanEntity(this);
		}
		@Override
		public void t_() {
			this.testCollision();
