...
public class CraftSilverfishEntity extends CraftSilverfish implements BasicNMSEntity {
	
	public CraftSilverfishEntity(SilverfishEntity entity) {
	...
	public void setFrozen(boolean b) {
		((SilverfishEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((SilverfishEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((SilverfishEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((SilverfishEntity)entity).willSave;
	}
	public static class SilverfishEntity extends EntitySilverfish implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftSilverfishEntity(this);
		}
		@Override
		public void t_() {
			this.testCollision();
