...
public class CraftGhastEntity extends CraftGhast implements BasicNMSEntity {
	
	public CraftGhastEntity(GhastEntity entity) {
	...
	public void setFrozen(boolean b) {
		((GhastEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((GhastEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((GhastEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((GhastEntity)entity).willSave;
	}
	
	public static class GhastEntity extends EntityGhast implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftGhastEntity(this);
		}
		@Override
		public void t_() {
			this.testCollision();
