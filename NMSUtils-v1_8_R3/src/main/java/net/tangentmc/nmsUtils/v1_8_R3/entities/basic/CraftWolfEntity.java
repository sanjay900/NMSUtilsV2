...
public class CraftWolfEntity extends CraftWolf implements BasicNMSEntity {
	
	public CraftWolfEntity(WolfEntity entity) {
	...
	public void setFrozen(boolean b) {
		((WolfEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((WolfEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((WolfEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((WolfEntity)entity).willSave;
	}
	public static class WolfEntity extends EntityWolf implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftWolfEntity(this);
		}
		@Override
		public void t_() {
			this.testCollision();
