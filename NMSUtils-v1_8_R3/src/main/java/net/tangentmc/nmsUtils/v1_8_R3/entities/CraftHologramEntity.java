...
import net.tangentmc.nmsUtils.v1_8_R3.entities.CraftHologramEntity.CraftHologramPart.HeadHologramEntity;
import net.tangentmc.nmsUtils.v1_8_R3.entities.CraftHologramEntity.CraftHologramPart.HologramPart;
...
import net.tangentmc.nmsUtils.v1_8_R3.entities.basic.CraftArmorStandEntity;
...
public class CraftHologramEntity extends CraftEntity implements NMSHologram {
	...
	public static class HologramEntity extends net.minecraft.server.v1_8_R3.Entity {
		...
		public void remove() {
			...
			lines.stream().map(en -> (Entity)en).forEach(en -> {
				if (en.passenger != null) en.passenger.getBukkitEntity().remove();
		...
		public Entity[] getAll() {
			...
			lines.forEach(w->{
				...
				if (((Entity)w).passenger != null)
				wontCollide.add(((Entity) w).passenger);
				if (((Entity)w).vehicle != null)
				wontCollide.add(((Entity) w).vehicle);
			});
