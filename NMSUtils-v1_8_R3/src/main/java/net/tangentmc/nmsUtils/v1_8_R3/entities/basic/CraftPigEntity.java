...
public class CraftPigEntity extends CraftPig implements BasicNMSEntity {
	
	public CraftPigEntity(PigEntity entity) {
	...
	public void setFrozen(boolean b) {
		((PigEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((PigEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((PigEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((PigEntity)entity).willSave;
	}
	public static class PigEntity extends EntityPig implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftPigEntity(this);
		}
		@Override
		public void t_() {
			this.testCollision();
