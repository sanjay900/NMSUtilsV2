package net.tangentmc.nmsUtils.v1_8_R3.entities.effects;
...
public interface Collideable {
	...
	default void testCollision(Entity... ignore) {
		...
		if (en.vehicle != null) list.remove(en.vehicle);
		if (en.passenger != null) list.remove(en.passenger);
		...
		if (movingobjectposition == null) {
			vec3d1 = new Vec3D(en.locX, vec3d.b, en.locZ);
