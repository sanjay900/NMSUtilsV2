...
import net.tangentmc.nmsUtils.v1_8_R3.entities.CraftHologramEntity.CraftHologramPart.BlockHologramEntity;
import net.tangentmc.nmsUtils.v1_8_R3.entities.CraftHologramEntity.CraftHologramPart.BlockHologramEntity.HologramBlock;
import net.tangentmc.nmsUtils.v1_8_R3.entities.CraftHologramEntity.CraftHologramPart.ItemHologramEntity;
import net.tangentmc.nmsUtils.v1_8_R3.entities.CraftHologramEntity.CraftHologramPart.ItemHologramEntity.HologramItem;
import net.tangentmc.nmsUtils.v1_8_R3.entities.CraftHologramEntity.CraftHologramPart.TextHologramEntity;
import net.tangentmc.nmsUtils.v1_8_R3.entities.LaserEntities.CraftLaserDestinationEntity.LaserDestinationEntity;
import net.tangentmc.nmsUtils.v1_8_R3.entities.LaserEntities.CraftLaserSourceEntity.LaserSourceEntity;
...
import net.tangentmc.nmsUtils.v1_8_R3.entities.basic.CraftMinecartCommandBlockEntity.MinecartCommandBlockEntity;
...
public enum NMSEntityTypes {
	...
	ARROW("Arrow", 10, EntityType.ARROW, EntityArrow.class, ArrowEntity.class),
	...
	LASERDESTINATION("LaserDestination", 94, EntityType.SQUID, EntitySquid.class, LaserDestinationEntity.class, false),
	...
	private Class<? extends net.minecraft.server.v1_8_R3.Entity> nmsClass;
	private Class<? extends net.minecraft.server.v1_8_R3.Entity> customClass;
	boolean override;
	NMSEntityTypes(String name, int id, EntityType entityType, Class<? extends net.minecraft.server.v1_8_R3.Entity> nmsClass,
				   Class<? extends net.minecraft.server.v1_8_R3.Entity> customClass) {
		this.name = name;
		this.id = id;
	...
	public static Class<? extends net.minecraft.server.v1_8_R3.Entity> getClassById(String id) {
