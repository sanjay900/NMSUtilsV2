...
{
	/**
	 * Calculate a parabolic arc from one location to another
	 * @param from Origin expressed as a vector
	 * @param to Destination expressed as a vector
	 * @param heightGain The height of the arc
	 * @return
	 */
