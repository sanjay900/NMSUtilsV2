...
public class CraftVillagerEntity extends CraftVillager implements BasicNMSEntity {
	
	public CraftVillagerEntity(VillagerEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((VillagerEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((VillagerEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((VillagerEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((VillagerEntity)entity).willSave;
	}
	public static class VillagerEntity extends EntityVillager implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftVillagerEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
