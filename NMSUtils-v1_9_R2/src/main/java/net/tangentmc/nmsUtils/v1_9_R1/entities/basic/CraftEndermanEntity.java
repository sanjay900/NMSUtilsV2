...
public class CraftEndermanEntity extends CraftEnderman implements BasicNMSEntity {
	
	public CraftEndermanEntity(EndermanEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((EndermanEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((EndermanEntity) entity).isFrozen();
	}
	public void setWillSave(boolean b) {
		((EndermanEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((EndermanEntity)entity).willSave;
	}
	public static class EndermanEntity extends EntityEnderman implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftEndermanEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
