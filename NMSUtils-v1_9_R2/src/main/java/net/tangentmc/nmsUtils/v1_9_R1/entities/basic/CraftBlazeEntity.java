...
public class CraftBlazeEntity extends CraftBlaze implements BasicNMSEntity {
	
	public CraftBlazeEntity(BlazeEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((BlazeEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((BlazeEntity) entity).isFrozen();
	}
	public void setWillSave(boolean b) {
		((BlazeEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((BlazeEntity)entity).willSave;
	}
	public static class BlazeEntity extends EntityBlaze implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftBlazeEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
