...
public class CraftCowEntity extends CraftCow implements BasicNMSEntity {
	
	public CraftCowEntity(CowEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((CowEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((CowEntity) entity).isFrozen();
	}
	public void setWillSave(boolean b) {
		((CowEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((CowEntity)entity).willSave;
	}
	public static class CowEntity extends EntityCow implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftCowEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
