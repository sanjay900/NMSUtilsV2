...
public class CraftShulkerEntity extends CraftShulker implements BasicNMSEntity {
	
	public CraftShulkerEntity(ShulkerEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	public void setFrozen(boolean b) {
		((ShulkerEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((ShulkerEntity) entity).isFrozen();
	}
	@Override
	public void setWillSave(boolean b) {
		((ShulkerEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((ShulkerEntity)entity).willSave;
	}
	public static class ShulkerEntity extends EntityShulker implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftShulkerEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
