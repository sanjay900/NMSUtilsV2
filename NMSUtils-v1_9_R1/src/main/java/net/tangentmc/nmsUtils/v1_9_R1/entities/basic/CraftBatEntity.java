...
public class CraftBatEntity extends CraftBat implements BasicNMSEntity {
	
	public CraftBatEntity(BatEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	public void setFrozen(boolean b) {
		((BatEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((BatEntity) entity).isFrozen();
	}
	@Override
	public void setWillSave(boolean b) {
		((BatEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((BatEntity)entity).willSave;
	}
	public static class BatEntity extends EntityBat implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftBatEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
