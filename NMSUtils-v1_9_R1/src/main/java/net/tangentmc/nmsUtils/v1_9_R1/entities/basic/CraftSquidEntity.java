...
public class CraftSquidEntity extends CraftSquid implements BasicNMSEntity {
	
	public CraftSquidEntity(SquidEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((SquidEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((SquidEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((SquidEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((SquidEntity)entity).willSave;
	}
	public static class SquidEntity extends EntitySquid implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftSquidEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
