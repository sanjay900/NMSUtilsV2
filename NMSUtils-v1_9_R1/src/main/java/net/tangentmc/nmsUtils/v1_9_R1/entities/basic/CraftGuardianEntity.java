...
public class CraftGuardianEntity extends CraftGuardian implements BasicNMSEntity {
	
	public CraftGuardianEntity(GuardianEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((GuardianEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((GuardianEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((GuardianEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((GuardianEntity)entity).willSave;
	}
	public static class GuardianEntity extends EntityGuardian implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftGuardianEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
