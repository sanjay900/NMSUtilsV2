...
public class CraftEnderDragonEntity extends CraftEnderDragon implements BasicNMSEntity {
	
	public CraftEnderDragonEntity(EnderDragonEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((EnderDragonEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((EnderDragonEntity) entity).isFrozen();
	}
	public void setWillSave(boolean b) {
		((EnderDragonEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((EnderDragonEntity)entity).willSave;
	}
	public static class EnderDragonEntity extends EntityEnderDragon implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftEnderDragonEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
