...
public class CraftSkeletonEntity extends CraftSkeleton implements BasicNMSEntity {
	
	public CraftSkeletonEntity(SkeletonEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((SkeletonEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((SkeletonEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((SkeletonEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((SkeletonEntity)entity).willSave;
	}
	public static class SkeletonEntity extends EntitySkeleton implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		...
		public CraftEntity getBukkitEntity() {
			return new CraftSkeletonEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
