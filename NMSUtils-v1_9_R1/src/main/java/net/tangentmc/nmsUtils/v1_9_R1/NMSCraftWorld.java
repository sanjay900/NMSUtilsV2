	        ...
	        if (Boat.class.isAssignableFrom(clazz)) {
	            ...
	            if (Snowball.class.isAssignableFrom(clazz)) {
	            	...
	            	if (LingeringPotion.class.isAssignableFrom(clazz)) {
	                    entity = new PotionEntity(world, x, y, z, CraftItemStack.asNMSCopy(new ItemStack(org.bukkit.Material.LINGERING_POTION, 1)));
	                } else {
	                    entity = new PotionEntity(world, x, y, z, CraftItemStack.asNMSCopy(new ItemStack(org.bukkit.Material.SPLASH_POTION, 1)));
	                }
	            ...
	            for (BlockFace dir : faces) {
	                ...
	                if (nmsBlock.getBlockData().getMaterial().isBuildable() || BlockDiodeAbstract.isDiode(nmsBlock.getBlockData())) {
	                    ...
	                    List<net.minecraft.server.v1_9_R1.Entity> list = (List<net.minecraft.server.v1_9_R1.Entity>) world.getEntities(null, bb);
