...
public class CraftGiantZombieEntity extends CraftGiant implements BasicNMSEntity {
	
	public CraftGiantZombieEntity(GiantZombieEntity entity) {
		super((CraftServer) Bukkit.getServer(), entity);
	}
	
	public void setFrozen(boolean b) {
		((GiantZombieEntity) entity).setFrozen(b);
	}
	public boolean isFrozen() {
		return ((GiantZombieEntity) entity).isFrozen();
	}

	@Override
	public void setWillSave(boolean b) {
		((GiantZombieEntity)entity).willSave = b;
	}
	@Override
	public boolean willSave() {
		return ((GiantZombieEntity)entity).willSave;
	}
	
	public static class GiantZombieEntity extends EntityGiantZombie implements Collideable{
		@Getter
		@Setter
		boolean frozen;
		public GiantZombieEntity(World world) {
			super(world);
		}
		@Override
		public CraftEntity getBukkitEntity() {
			return new CraftGiantZombieEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
