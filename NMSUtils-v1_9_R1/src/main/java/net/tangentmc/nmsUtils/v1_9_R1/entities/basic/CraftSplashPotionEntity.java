...
import org.bukkit.craftbukkit.v1_9_R1.entity.CraftSplashPotion;
...
public class CraftSplashPotionEntity extends CraftSplashPotion implements BasicNMSEntity {

	public CraftSplashPotionEntity(PotionEntity entity) {
	...
	public static class PotionEntity extends EntityPotion implements Collideable{
		...
		public CraftEntity getBukkitEntity() {
			return new CraftSplashPotionEntity(this);
		}
		@Override
		public void m() {
			this.testCollision();
