package net.tangentmc.nmsUtils.v1_11_R1;
...
import net.tangentmc.nmsUtils.v1_11_R1.entities.CraftHologramEntity;
import net.tangentmc.nmsUtils.v1_11_R1.entities.NPC;
import net.tangentmc.nmsUtils.v1_11_R1.entities.basic.BasicNMSArmorStand;
import net.tangentmc.nmsUtils.v1_11_R1.entities.basic.BasicNMSEntity;
import net.tangentmc.nmsUtils.v1_11_R1.entities.basic.NMSHologramWrapper;
...
public class NMSUtilImpl implements NMSUtil, Listener, Runnable {
    ...
    private net.minecraft.server.v1_11_R1.World getWorld(World w) {
    ...
    public static NBTTagCompound getTag(net.minecraft.server.v1_11_R1.Entity en) {
    ...
    public void run() {
        for (World w : Bukkit.getWorlds()) {
            for (Entity en : w.getEntities()) {
                net.minecraft.server.v1_11_R1.Entity added = ((CraftEntity) en).getHandle();
    ...
    public static boolean addEntityToWorld(WorldServer nmsWorld, net.minecraft.server.v1_11_R1.Entity nmsEntity) {
