...
import net.tangentmc.nmsUtils.v1_11_R1.NMSUtilImpl;
import net.tangentmc.nmsUtils.v1_11_R1.entities.CraftHologramEntity.CraftHologramPart.BlockHologramEntity;
import net.tangentmc.nmsUtils.v1_11_R1.entities.CraftHologramEntity.CraftHologramPart.HeadHologramEntity;
import net.tangentmc.nmsUtils.v1_11_R1.entities.CraftHologramEntity.CraftHologramPart.ItemHologramEntity;
import net.tangentmc.nmsUtils.v1_11_R1.entities.basic.NullBoundingBox;
import net.tangentmc.nmsUtils.v1_11_R1.entities.effects.Collideable;
...
public class CraftHologramEntity extends CraftEntity {
    ...
    public static class HologramEntity extends net.minecraft.server.v1_11_R1.Entity {
    ...
    public static class CraftHologramStand extends org.bukkit.craftbukkit.v1_11_R1.entity.CraftArmorStand {
    ...
    public static class CraftHologramPart extends org.bukkit.craftbukkit.v1_11_R1.entity.CraftEntity {
        private HologramEntity parent;
        ...
        public static class BlockHologramEntity implements HologramPart {
            ...
            public static class HologramBlock extends EntityFallingBlock {
                ...
                public HologramBlock(World world, Location loc, ItemStack it, BlockHologramEntity parent) {
                    super(world,loc.getX(),loc.getY(),loc.getZ(),net.minecraft.server.v1_11_R1.Block.getById(it.getType().getId()).fromLegacyData(it.getData().getData()));
                    this.parent = parent;
                    this.setNoGravity(true);
                }
                @Override
