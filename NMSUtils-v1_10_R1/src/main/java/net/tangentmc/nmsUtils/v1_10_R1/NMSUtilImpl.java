...
public class NMSUtilImpl implements NMSUtil, Listener, Runnable {
    ...
    public NMSUtilImpl() {
        ...
        validateEntityMethod = net.minecraft.server.v1_10_R1.World.class.getDeclaredMethod("b", net.minecraft.server.v1_10_R1.Entity.class);
    ...
    public static boolean addEntityToWorld(net.minecraft.server.v1_10_R1.World world, net.minecraft.server.v1_10_R1.Entity nmsEntity) {
