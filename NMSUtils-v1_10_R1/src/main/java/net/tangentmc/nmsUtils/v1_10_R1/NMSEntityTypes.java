...
import net.tangentmc.nmsUtils.v1_10_R1.entities.LaserEntities;
...
public enum NMSEntityTypes {
    ...
    LASERORIGIN("LaserSource", 68, EntityType.GUARDIAN, EntityGuardian.class, LaserEntities.CraftLaserSourceEntity.LaserSourceEntity.class),
    LASERDEST("LaserDest", 94, EntityType.SQUID, EntitySquid.class, LaserEntities.CraftLaserDestinationEntity.LaserDestinationEntity.class),
    ...
    private Class<? extends net.minecraft.server.v1_10_R1.Entity> nmsClass;
    private Class<? extends net.minecraft.server.v1_10_R1.Entity> customClass;
